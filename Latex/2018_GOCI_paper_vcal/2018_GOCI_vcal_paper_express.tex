...
The GOCI Clear Water Subset (\autoref{fig:GOCI_map}) was used as calibration site because it is a ocean ocean location that is oligotrophic water far from land or active volcanics islands, and therefore, the dominant aerosols result from purely maritime processes \cite{Franz:07}.
Straight light correction \cite{Kim:2015,Kim:2016}
to avoid the difference in acquisition time among slots
...
\begin{figure}[H]
  ...
  \includegraphics[trim=0 0 0 0,width=8cm]{./Figures/GOCI_MAP.eps}
    %\internallinenumbers
    \caption{Map of the GOCI Clear Water Subset (GCWS) region used as the calibration site indicated as a blue box with limits $26^o 5' 45''N$-$28^o 29' 42''N$ and $137^o 20' 16.8''E$-$142^o 5' 31.2''$. The GOCI coverage is indicated as red box and the slot 13 as black box. The GCWS was chosen as a subset of slot 12 to avoid slot edges distortion and over a low productivity water region. \label{fig:GOCI_map}} 
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[trim=50 0 0 0,width=15cm]{./Figures/Gvcal_MA.pdf}
    %\internallinenumbers
...
\begin{figure}[H]
  \centering
  \includegraphics[trim=50 0 0 0,width=15cm]{./Figures/Gvcal_SW.pdf}
    %\internallinenumbers
