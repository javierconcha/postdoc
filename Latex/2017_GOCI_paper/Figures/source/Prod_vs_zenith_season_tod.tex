...
\begin{overpic}[trim=0 0 0 0,clip,height=1.3cm]{./Rrs_412_vs_Zenith_Spring_tod.eps}    
  ...
  \put (-40,35) {\colorbox{white}{412 nm}} 
  \end{overpic}
\end{minipage}
\hspace{-0.65cm}
\begin{minipage}[c]{0.24\linewidth}
...
\begin{minipage}[c]{0.24\linewidth}
  ...
  % \put (-40,38) {\colorbox{white}{$\lambda $}}
  \put (-36,35) {\colorbox{white}{443 nm}}
  \end{overpic}
\end{minipage}
\hspace{-0.65cm}
\begin{minipage}[c]{0.24\linewidth}
...
\begin{minipage}[c]{0.24\linewidth}
  ...
  % \put (-40,38) {\colorbox{white}{$\lambda $}}
  \put (-40,35) {\colorbox{white}{490 nm}}
  \end{overpic}
\end{minipage}
\hspace{-0.65cm}
\begin{minipage}[c]{0.24\linewidth}
...
\begin{minipage}[c]{0.24\linewidth}
  ...
  % \put (-40,38) {\colorbox{white}{$\lambda $}}
  \put (-40,35) {\colorbox{white}{660 nm}}
  \end{overpic}
\end{minipage}
\hspace{-0.65cm}
\begin{minipage}[c]{0.24\linewidth}
...
\begin{minipage}[c]{0.24\linewidth}
  ...
  % \put (-40,38) {\colorbox{white}{$\lambda $}}
  \put (-40,35) {\colorbox{white}{680 nm}}
  \end{overpic}
\end{minipage}
\hspace{-0.65cm}
\begin{minipage}[c]{0.24\linewidth}
...
\begin{minipage}[c]{0.24\linewidth}
  ...
  \put (-45,38) {\colorbox{white}{$a_\text{g}(412)$}}
  % \put (-40,24) {\colorbox{white}{412 nm}}
  \end{overpic}
\end{minipage}
\hspace{-0.65cm}
\begin{minipage}[c]{0.24\linewidth}
