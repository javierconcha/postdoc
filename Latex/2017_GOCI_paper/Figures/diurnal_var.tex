...
\begin{tabular}{@{\extracolsep{4pt}}ScSc ScScScScScScc ScScScScScScSc@{}} \hline
   				...
   				& 	RMSE				&$\pm2\cdot$(Mean 		& \multicolumn{6}{c}{CV[\%]} & $\pm2\cdot$(Mean & \multicolumn{6}{c}{CV[\%]} \\ \cline{4-9} \cline{11-16}
Product  		& 	$[sr^{-1}]$			& diurnal SD)\tnote{*}  & Min. 	& Max. 		& Mean 	& Median 		& SD  	& N 					& diurnal SD)\tnote{*} 	& Min. 	& Max. 	& Mean 	& Median 	& SD  	& N\\ \cline{1-2} \cline{3-9} \cline{10-16}
