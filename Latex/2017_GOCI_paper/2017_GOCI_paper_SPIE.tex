...
\begin{figure}[htb!]
  ...
  \begin{minipage}[c]{1.0\linewidth}
      \centering
      \includegraphics[height=6.5cm]{./Figures/GOCI_AERO_660.png}
...
\begin{figure}[htb!]
    \begin{minipage}[c]{0.5\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=5.0cm]{./Figures/InterComp_Rrs412.eps} \put (83,10) {(a)}
      \end{overpic}
    \end{minipage}   
    \hfill
    \begin{minipage}[c]{0.5\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=5.0cm]{./Figures/InterComp_Rrs443.eps} \put (83,10) {(b)}
      \end{overpic}
    \end{minipage}   

    \begin{minipage}[c]{0.5\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=5.0cm]{./Figures/InterComp_Rrs490.eps} \put (83,10) {(c)}
      \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.5\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=5.0cm]{./Figures/InterComp_Rrs555.eps} \put (83,10) {(d)}
      \end{overpic}
    \end{minipage}   

    \begin{minipage}[c]{0.5\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=5.0cm]{./Figures/InterComp_Rrs660.eps} \put (83,10) {(e)}
      \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.5\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=5.0cm]{./Figures/InterComp_Rrs680.eps} \put (83,10) {(f)}
      \end{overpic}
    \end{minipage}   
