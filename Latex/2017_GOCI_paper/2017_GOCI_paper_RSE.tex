...
\end{equation}
\noindent where N is the total number of matchups.
\begin{equation}
...
\multirow{5}{*}{412 (412)}  &  0h $\&$ 1h  & 0.85    & 0.86    & -0.0009 & 0.0018      & 15  & 57.3    & 39.5        & 54.6        & -35.5    & 0.67    & 0.384   \\ 
                            ...
                            &  all         & 0.81    & 0.83    & -0.0002 & 0.0021      & 45  & 40.1    & 38.7        & 27.5        & -20.4    & 0.83    & 0.146   \\ \hline 
\multirow{5}{*}{443 (443)}  &  0h $\&$ 1h  & 0.96    & 0.90    & -0.0007 & 0.0014      & 16  & 34.6    & 25.4        & 37.6        & -23.4    & 0.62    & 0.224   \\ 
                            ...
                            &  all         & 0.91    & 0.91    & -0.0003 & 0.0017      & 45  & 28.0    & 25.1        & 20.1        & -13.2    & 0.86    & 0.145   \\ \hline 
\multirow{5}{*}{490 (490)}  &  0h $\&$ 1h  & 0.98    & 0.79    & -0.0004 & 0.0024      & 16  & 31.3    & 21.4        & 29.1        & -26.8    & 0.70    & 0.094   \\ 
                            ...
                            &  all         & 0.95    & 0.82    & -0.0004 & 0.0029      & 45  & 25.7    & 16.3        & 21.9        & -21.0    & 0.79    & 0.095   \\ \hline 
\multirow{5}{*}{555 (555)}  &  0h $\&$ 1h  & 0.97    & 0.80    & -0.0004 & 0.0024      & 16  & 26.4    &  9.7        & 28.0        & -24.6    & 0.71    & 0.066   \\ 
                            ...
                            &  all         & 0.98    & 0.80    & -0.0003 & 0.0029      & 45  & 22.8    & 10.1        & 21.4        & -22.4    & 0.78    & 0.072   \\ \hline 
\multirow{5}{*}{660 (665)}  &  0h $\&$ 1h  & 0.98    & 0.96    & -0.0004 & 0.0005      & 16  & 55.1    & 28.8        & 65.5        & -24.0    & 0.34    & 0.264   \\ 
                            ...
                            &  all         & 0.97    & 0.90    & -0.0003 & 0.0007      & 45  & 39.3    & 28.2        & 27.1        & -22.2    & 0.72    & 0.253   \\ 
\hline 
\end{tabular}
\end{table}
% ++++++++++++++++++++++++++++++++++++++++++
...
\begin{figure}[H]
    \begin{minipage}[c]{0.48\linewidth}
      \centering
       \begin{overpic}[trim=0 0 0 0,clip,height=6.0cm]{./Figures/GOCI_AERO_412.eps} \put (85,20) {(a)}
       \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.48\linewidth}
      \centering
       \begin{overpic}[trim=0 0 0 0,clip,height=6.0cm]{./Figures/GOCI_AERO_443.eps} \put (85,20) {(b)}
       \end{overpic}
    \end{minipage}  

  \begin{minipage}[c]{0.48\linewidth}
      \centering
       \begin{overpic}[trim=0 0 0 0,clip,height=6.0cm]{./Figures/GOCI_AERO_490.eps} \put (85,20) {(c)}
       \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.48\linewidth}
      \centering
       \begin{overpic}[trim=0 0 0 0,clip,height=6.0cm]{./Figures/GOCI_AERO_555.eps} \put (85,20) {(d)}
       \end{overpic}
    \end{minipage}  

  \begin{minipage}[c]{0.48\linewidth}
      \centering
       \begin{overpic}[trim=0 0 0 0,clip,height=6.0cm]{./Figures/GOCI_AERO_660.eps} \put (85,20) {(e)}
       \end{overpic}
    \end{minipage}   
    \hfill
  \begin{minipage}[c]{0.48\linewidth}
...
\autoref{fig:GOCI_TimeSeries}.(a-l) shows time series and histograms for the $R_{rs}(\lambda)$ for GOCI. The complete GOCI mission was processed to level 2 and then a filtered mean for the area of study was calculated. Only values that passed the filtering criteria described previously were used. Note that for each there are potentially eight values displayed, which explains the daily spread of the data. Also, note that some values are negative for the 660 and 680 nm spectral bands, reflecting the failure of the atmospheric correction. However, from the histogram for these bands, it can be seen that the mean values are close to zero. \autoref{fig:GOCI_TimeSeries2} shows time series for the Chlorophyll-{\it a}, $a_{g:mlrc}(412)$ and POC products. The time series exhibit a expected seasonal variability, which is correlated to the changes in solar zenith angles throughout the year (\autoref{fig:GOCI_TimeSeries2}.(g)). 
%-%-%-%-%-%-%-%-%-%-%=FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.66\linewidth}
      \centering
      \begin{overpic}[trim=0 352 0 0,clip,height=3.8cm]{./Figures/TimeSerie_Rrs680.eps} \put (90,28) {(k)}
      \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.33\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=3.2cm]{./Figures/Hist_Rrs680.eps} \put (78,68) {(l)}
      \end{overpic} 
    \end{minipage} 



    \caption{Time Series and histograms. The complete GOCI mission was processed to level 2 and a filtered mean was calculated for each image over the area of study. The spread of the data is due to the multiple images per day. \label{fig:GOCI_TimeSeries} } 
\end{figure}
%-%-%-%-%-%-%-%-%-%-%=END FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.66\linewidth}
      \centering
      \begin{overpic}[trim=0 352 0 0,clip,height=3.6cm]{./Figures/TimeSerie_chlor_a.eps} \put (90,28) {(a)}
      \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.33\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=3.2cm]{./Figures/Hist_chlor_a.eps} \put (78,25) {(b)}
      \end{overpic} 
    \end{minipage}        

    \begin{minipage}[c]{0.66\linewidth}
      \centering
      \begin{overpic}[trim=12 352 0 0,clip,height=3.6cm]{./Figures/TimeSerie_ag_412_mlrc.eps} \put (90,28) {(c)}
      \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.33\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=3.2cm]{./Figures/Hist_ag_412_mlrc.eps} \put (78,25) {(d)}
      \end{overpic} 
    \end{minipage}    

        \begin{minipage}[c]{0.66\linewidth}
      \centering
      \begin{overpic}[trim=-15 352 0 0,clip,height=3.6cm]{./Figures/TimeSerie_poc.eps} \put (90,28) {(e)}
      \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.33\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=3.2cm]{./Figures/Hist_poc.eps} \put (78,25) {(f)}
      \end{overpic} 
    \end{minipage}    

    \begin{minipage}[c]{0.66\linewidth}
      \centering
      \begin{overpic}[trim=10 0 0 390,clip,height=3.5cm]{./Figures/TimeSerie_Rrs680.eps} \put (90,25) {(g)}
      \end{overpic}
    \end{minipage}   
...
\begin{figure}[H]
    \begin{minipage}[c]{0.48\linewidth}
      \centering
      \includegraphics[height=5.5cm]{./Figures/Rel_Diff_mid_three_Rrs412.eps}
    \centerline{(a)}\medskip
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.48\linewidth}
      \centering
      \includegraphics[height=5.5cm]{./Figures/Rel_Diff_mid_three_Rrs443.eps}
      \centerline{(b)}\medskip
    \end{minipage}  

  \begin{minipage}[c]{0.48\linewidth}
      \centering
      \includegraphics[height=5.5cm]{./Figures/Rel_Diff_mid_three_Rrs490.eps}
    \centerline{(c)}\medskip
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.48\linewidth}
      \centering
      \includegraphics[height=5.5cm]{./Figures/Rel_Diff_mid_three_Rrs555.eps}
      \centerline{(d)}\medskip
    \end{minipage}  

  \begin{minipage}[c]{0.48\linewidth}
      \centering
      \includegraphics[height=5.5cm]{./Figures/Rel_Diff_mid_three_Rrs660.eps}
      \centerline{(e)}\medskip
    \end{minipage}   
        \hfill
    \begin{minipage}[c]{0.48\linewidth}
      \centering
      \includegraphics[height=5.5cm]{./Figures/Rel_Diff_mid_three_Rrs680.eps}
