...
\node (CV) [decision, below of=zenith, yshift=-2cm] {Median[CV]$<3.0$?};
...
\begin{figure}[htb!]
    \begin{minipage}[c]{0.66\linewidth}
      \centering
      \begin{overpic}[trim=0 352 0 0,clip,height=3.6cm]{./Figures/TimeSerie_Rrs680.eps} \put (90,28) {(l)}
      \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.33\linewidth}
    ...
    \begin{minipage}[c]{0.66\linewidth}
      \centering
      \begin{overpic}[trim=0 352 0 0,clip,height=3.6cm]{./Figures/TimeSerie_Chla.eps} \put (90,28) {(n)}
      \end{overpic}
    \end{minipage}  
    \hfill
    \begin{minipage}[c]{0.33\linewidth}
    ...
    \begin{minipage}[c]{0.66\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 350,clip,height=3.6cm]{./Figures/TimeSerie_Rrs680.eps} \put (90,28) {(p)}
      \end{overpic}
    \end{minipage}   
