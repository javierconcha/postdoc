...
The primary assumption for this work is that the water over the area of study stays homogeneous over short periods of time, i.e. the water does not change considerably diurnally (hour-to-hour) nor from day-to-day. In order to test this assumption, different studies were performed and described below.
...
\autoref{fig:Rrs_vs_zenith} shows the $R_{rs}$ filtered mean values for each time of the day for the area of study versus the solar zenith angle (SZA) for the whole mission. Only data that passed the exclusion criteria described previously but including the negative values are plotted. The data are color coded by time of the day (red: 0h, green: 1h, blue: 2h, black: 3h, cyan: 4h, magenta: 5h, orange: 6h, and purple: 7h). \autoref{fig:Rrs_vs_zenith_season} in the Appendix section shows the same data but color coded by season. The data present a trend that gets closer to zero and even negative values at the highest solar zenith angles associated with the late time of the day (6h and 7h) and fall and winter. The number of negative values, and therefore, the failure of the atmospheric correction, increases for the 660 nm band and specially the 680 band, where the most of values are negative for all time of the day and solar zenith angles. This trend could be related to seasonality. In order to analyze further this hypothesis, the data were de-seasoned as explained below.
%-%-%-%-%-%-%-%-%-%-%=FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\begin{figure}[H]
    \begin{minipage}[c]{0.49\linewidth}
      \centering
...
%-%-%-%-%-%-%-%-%-%-%=END FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\autoref{fig:par_vs_zenith} shows the the Chlorophyll-{\it a}, $a_{g:mlrc}(412)$ and POC products versus the solar zenith angle for the area of study. The data are color coded by time of the day. \autoref{fig:par_vs_zenith_season} in the Appendix section shows the same data but color coded by season. 
%-%-%-%-%-%-%-%-%-%-%=FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\begin{figure}[H]
 \begin{minipage}[c]{0.49\linewidth}
      \centering
...
% Relative difference
In other to have a better estimation of the uncertainties, the relative difference of time of the day $t$ with respect to the three midday average ($RD_t$) was calculated. For each day, the mean of the three midday images (02, 03 and 04h) $\bar{X}_{2,3,4h}$ was calculated as
\begin{linenomath*}
\begin{equation}
	\bar{X}_{2,3,4\text{h}} = \frac{1}{N} \sum_{t}^N x_t,~~~t=\text{2h,~3h~and~4h}
\end{equation}
\end{linenomath*}
...
If we define the difference con respect to a reference as $\Delta_t=x_t-x_{reference}$, then, the relative difference is defined as
\begin{linenomath*}
\begin{equation}
...
\autoref{fig:DiffMidThreeMean} and \autoref{tab:rel_diff} shows the mean and the standard deviation (error bar in the figure) of the relative difference with respect to the mean of the three midday images (02, 03 and 04h) for the whole mission for $R_{rs}(\lambda)$ and Chlorophyll-{\it a}, POC and $a_{g:mlrc}(412)$ for each time of the day. \autoref{fig:DiffMidThreeMean_detrend} shows the same parameters but for the anomalies. The relative differences are smaller that 10\% for the 412 and 443 nm bands for all times of the day. For the 490 and 555 nm bands, the relative differences are larger than 10\% for the last two times of the day. For the 660 band, the relative differences are smaller than 10\% for the 4h, 6h and 7h times of the day. For the 680 nm band, the relative differences are larger than 10\% for all times of the day except 4h, being significantly large for the 0h and 1h time of the day. For the 412, 443, 490 and 555 nm bands, the first five times of the day have a smaller standard deviation for the relative difference compared with last three.

The relative differences for Chlorophyll-{\it a}, POC and $a_{g:mlrc}(412)$ for each time of the day are less than 5\% for all times of the day but 6h and 7h, which are still less than 10\%. For all three products, the standard deviation is larger for the last two time of the day.
...
Product     &    Mean(SD)    & Mean(SD)  &  Mean(SD)  &  Mean(SD)  &  Mean(SD)  &  Mean(SD)  &  Mean(SD)   &  Mean(SD)   \\ 
    &    [\%]([\%])    & [\%]([\%])  &  [\%]([\%])  &  [\%]([\%])  &  [\%]([\%])  &  [\%]([\%])  &  [\%]([\%])   &  [\%]([\%])   \\ \hline \hline
412 &  -3.1 (3.3) & -0.2 (3.3) & 0.3 (1.7) & 0.5 (1.6) & -0.8 (1.7) & -3.7 (5.1) & -9.9  (7.9) & -9.8  (3.2) \\
443 &  -2.6 (3.2) &  0.1 (3.1) & 0.3 (1.8) & 0.4 (1.6) & -0.7 (1.7) & -3.0 (4.8) & -9.3  (7.6) & -8.3  (3.5) \\
490 &  -2.1 (3.5) &  0.8 (3.5) & 0.9 (1.9) & 0.4 (1.7) & -1.1 (1.5) & -3.8 (4.2) & -12.1 (7.9) & -11.2 (3.9) \\
555 &  -5.6 (5.9) &  0.6 (6.7) & 1.7 (4.2) & 0.7 (3.2) & -2.1 (2.6) & -7.0 (7.2) & -16.7 (7.8) & -13.3 (9.6) \\
660 & -13.8 (18.9) & 3.8 (29.0) & 3.6 (16.8) & 2.7 (19.1) & -7.2 (14.2) & -14.8 (22.3) & -9.9 (14.6) & 1.8 (3.7) \\
680 &  149.8 (222.0) & 128.5 (148.9) & 17.7 (37.8) & -11.3 (31.8) & -7.5 (26.2) & 12.6 (78.3) & 10.2 (114.1) & 24.8 (117.6) \\ 
...
% \end{figure}
Data from the Visible Infrared Imaging Radiometer Suite (VIIRS) on board the Suomi National Polar-orbiting Partnership (Suomi NPP) weather satellite and the Moderate Resolution Imaging Spectroradiometer (MODIS) aboard the Agua satellite (MODISA) over the same area of study were processed for comparison with GOCI. These data were filtered following the same previous exclusion criteria and then monthly averaged. 

\autoref{fig:CrossCompAllRrs}.(a) shows the cross-comparison for the monthly time series for GOCI, MODIS Aqua (MODISA) and VIIRS for all wavelengths. GOCI follows a similar trend as MODISA, being GOCI slightly smaller while VIIRS is larger overall when compared to GOCI and MODISA, specially for the 660 and 680 nm bands.
\autoref{fig:CrossCompAllRrs}.(b) shows the ratio by spectral bands for GOCI/MODISA, GOCI/VIIRS, and MODIS Aqua/VIIRS. For the GOCI/MODISA ratio, the mean value is close to one except for the 680 nm band, which suggests that the MODISA 678 nm band is brighter with a value more than double than the GOCI 680 nm band overall. Also, for the 660 nm band, the ratio is slightly smaller for some periods with an exception in the first months of 2013, where the ratio almost reaches three. For both the GOCI/VIIRS and the MODISA/VIIRS ratios, the ratio is close to one except for the 660 nm band.
%-%-%-%-%-%-%-%-%-%-%=FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\begin{figure}[H]
    \begin{minipage}[c]{0.49\linewidth}
      \centering
...
\end{figure}
%-%-%-%-%-%-%-%-%-%-%=END FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\autoref{fig:GOCI_TimeSeriesComp_par} shows the monthly time series comparison for GOCI, MODISA and VIIRS for chlor-{\it a}, $a_{g:mlrc}(412)$ and POC. The values match well for the most part for the three missions and for the three different products.
%-%-%-%-%-%-%-%-%-%-%=FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\begin{figure}[H]
    \begin{minipage}[c]{1.0\linewidth}
      \centering
    ...
    \internallinenumbers
    \caption{Time Series comparison for GOCI (blue solid line), MODISA (red solid line) and VIIRS (black solid line) for (a) chlor-{\it a}, (b) $a_{g:mlrc}(412)$ and (c) POC. \label{fig:GOCI_TimeSeriesComp_par}} 
\end{figure}
%-%-%-%-%-%-%-%-%-%-%=END FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
...
\begin{figure}[H]
    ...
    \begin{minipage}[c]{0.25\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=3.5cm]{./Figures/Scatter_GOCI_AQUA_412.eps} \put (77,30) {\colorbox{white}{(a)}} \put (-50,50) {\colorbox{white}{412 nm:}}
      \end{overpic}
    \end{minipage}   
    \begin{minipage}[c]{0.25\linewidth}
      \centering
    ...
    \begin{minipage}[c]{0.25\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=3.5cm]{./Figures/Scatter_GOCI_AQUA_443.eps} \put (77,30) {\colorbox{white}{(d)}} \put (-50,50) {\colorbox{white}{443 nm:}}
      \end{overpic}
    \end{minipage}   
    \begin{minipage}[c]{0.25\linewidth}
      \centering
    ...
    \begin{minipage}[c]{0.25\linewidth}
      \centering
      \begin{overpic}[trim=0 0 0 0,clip,height=3.5cm]{./Figures/Scatter_GOCI_AQUA_490.eps} \put (77,30) {\colorbox{white}{(g)}} \put (-50,50) {\colorbox{white}{490 nm:}}
      \end{overpic}
    \end{minipage}   
    \begin{minipage}[c]{0.25\linewidth}
      \centering
    ...
    \begin{minipage}[c]{0.25\linewidth}
      \centering
      \hspace{.4cm}
      \begin{overpic}[trim=0 0 0 0,clip,height=3.5cm]{./Figures/Scatter_GOCI_AQUA_555.eps} \put (23,17) {\colorbox{white}{(j)}} \put (-48,50) {\colorbox{white}{555 nm:}}
      \end{overpic}
    \end{minipage}   
    \begin{minipage}[c]{0.25\linewidth}
      \centering
    ...
    \begin{minipage}[c]{0.25\linewidth}
      \centering
      \hspace{.4cm}
      \begin{overpic}[trim=0 0 0 0,clip,height=3.5cm]{./Figures/Scatter_GOCI_AQUA_660.eps} \put (64,57) {\colorbox{white}{(m)}} \put (-48,50) {\colorbox{white}{660 nm:}}
      \end{overpic}
    \end{minipage}   
    \begin{minipage}[c]{0.25\linewidth}
      \centering
    ...
    \begin{minipage}[c]{0.25\linewidth}
      \centering
      \hspace{.4cm}
      \begin{overpic}[trim=0 0 0 0,clip,height=3.5cm]{./Figures/Scatter_GOCI_AQUA_680.eps} \put (65,32) {\colorbox{white}{(p)}} \put (-48,50) {\colorbox{white}{680 nm:}}
      \end{overpic}
    \end{minipage}   
    \begin{minipage}[c]{0.25\linewidth}
      \centering
...
% General
This study gives an estimation diurnal variability of the uncertainties for the GOCI instrument. 
The sources of these uncertainties could be from the instrument (e.g. electronic noise) and from the algorithms (e.g. solar geometry effects in the atmospheric correction).

% 4.1 Validation of the Atmospheric Correction ....................... 8 
%     4.1.1 AERONET-OC.................................. 8 
An validation using in situ data from the AERONET-OC was performed.
\todo{Check!}The validation with {\it in situ} data exhibit results comparable to heritage sensors.
An improvement to the vicarious calibration included in l2gen is needed.

%     4.1.2 Cruises Matchups?................................ 11
% 4.2 Time Series........................................ 11
The time series were analyzed.
Expected seasonality and trends were observed through the complete mission.
There is fewer data in the winter season. The reason could be the presence of clouds in the scene or the high SZA.
% 4.3 Temporal Homogeneity.................................. 14
The temporal homogeneity of the area of study was tested.

% 4.4 Products versus solar zenith angle ........................... 17
The behavior of the different products with respect to the solar zenith angle was analyzed in order to determine how much it affects the atmospheric correction.
...
The data were de-seasoned in order to analyze the presence of trends in the data and the existence of a correlation of these trends with the SZA. 
There is a slighty trend at higher SZA, specially for the data taken at the 6th abd 7th hour but because fewer data are available for these time of the day, it is not significant to be conclusive. 
...
It seems that this behaviour happens to SZA above $60^o$. 

% 4.5 Diurnal Differences and Uncertainties ......................... 21

The relative differences are smaller than $10\%$ for the six first images of the day for the blue and green bands, and increasing for the last two images across all wavelengths. A similar behaviour occurs for the geophysical products.

% 4.6 Sensor Cross-comparison................................. 25
The results from GOCI were compared with heritage sensors (MODISA and VIIRS).
Based on scatter plots (\autoref{fig:scatterRrs}) for the cross-comparison with the heritage mission, the uncertainties vary spectrally, being smaller in the blue and increasing towards the red. % from scatter plot
% from OO poster

% future work
To study the effect of the BRDF correction in the algorithm.
Plane-parallel versus Pseudo-Spherical geometry.
Estimation of changes due to diurnal and day-to-day biogeochemical stocks and processes in coastal oceans.

% Extras
The boxed area is covered by two slots, visually noticeable from the image. This can introduced uncertainties in the process. An solution from the Koreans is underway.
%%%%%%%%%%%%%%%%%%% SECTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \vspace{-.4cm}
...
% - Grand mean and the mean of the standard deviation for the 3-day sequences.
% - Distribution in time for the 228 3-day sequences.
% 3-day intervals
...
% When you show all the data for the region you are seen a significant seasonal pattern. When you are looking these 228 3-day sequences it seems that the variability in your Rrs is much lower or very minimal compared to the overall/full mission. So it seems there is...
