...
\end{figure}
%-%-%-%-%-%-%-%-%-%-%=END FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\autoref{fig:GOCI_TimeSeriesComp_par} shows the monthly time series comparison for GOCI, MODISA and VIIRS for chlor-{\it a}, $a_{g:mlrc}(412)$ and POC. All the missions follow similar values over time for the three different products.
%-%-%-%-%-%-%-%-%-%-%=FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\begin{figure}[H]
    \begin{minipage}[c]{1.0\linewidth}
      \centering
...
% \end{figure}
% %-%-%-%-%-%-%-%-%-%-%=END FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\autoref{fig:scatterRrs} shows the scatter plots for the $R_{rs}(\lambda)$ cross-comparison for GOCI, MODISA and VIIRS. These data are daily values and only values greater than zero are shown. \todo{Check!}The selection of the data over the area of study followed similar procedures to the ones described by \cite{Bailey2006} and only data that passed the exclusion criteria are used. As can be seen in the plots, there are few coincidental data among all missions and specially between MODISA and VIIRS for all bands. This could be caused by the failure of the atmospheric correction or presence of cloud in the scenes. The $R^2$ values are high for the 412 and 443 nm bands, and start to decrease for 490 nm and beyond. There are only a handful of coincidental data for MODISA versus GOCI for the 680 nm band.
%-%-%-%-%-%-%-%-%-%-%=FIGURE=%-%-%-%-%-%-%-%-%-%-%-%-%
\begin{figure}[H]
    \hspace{2.5cm}
...
\todo{Check!}Uncertainties vary spectrally, being larger in the blue and decreasing towards the red.
\todo{Wrong now. Check!}Uncertainty patterns are similar for the six first images of the day, increasing for the last two images across all wavelengths

% 4.6 Sensor Cross-comparison................................. 25
The results from GOCI were compared with heritage sensor (MODISA and VIIRS).
