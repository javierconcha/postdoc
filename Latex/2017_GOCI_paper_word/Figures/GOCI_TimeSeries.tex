...
\begin{minipage}[c]{0.33\linewidth}
  \centering
  \begin{overpic}[trim=0 0 0 0,clip,height=2.5cm]{./Hist_Rrs412.eps} \put (75,65) {\colorbox{white}{(b)}}
  \end{overpic} 
\end{minipage}  
...
\begin{minipage}[c]{0.33\linewidth}
  \centering
  \begin{overpic}[trim=0 0 0 0,clip,height=2.5cm]{./Hist_Rrs490.eps} \put (15,65) {\colorbox{white}{(f)}}
  \end{overpic} 
\end{minipage}  
...
\begin{minipage}[c]{0.33\linewidth}
  \centering
  \begin{overpic}[trim=0 0 0 0,clip,height=2.5cm]{./Hist_Rrs555.eps} \put (15,65) {\colorbox{white}{(h)}}
  \end{overpic} 
\end{minipage}  
