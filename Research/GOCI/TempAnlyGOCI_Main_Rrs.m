...
save('GOCI_TempAnly.mat','GOCI_DailyStatMatrix','-append')
...
for idx = 1:size(wl,2)
      eval(sprintf('cond1 = ~isnan([GOCI_DailyStatMatrix.Rrs_%s_mean_mid_three]);',wl{idx}));
      cond_used = cond1;
